import { Injectable, NgModule, Component, ViewContainerRef, Input, Output, AfterViewInit, EventEmitter, ViewEncapsulation, NgZone, ViewChild, ElementRef, Renderer, Renderer2, HostListener } from '@angular/core';
